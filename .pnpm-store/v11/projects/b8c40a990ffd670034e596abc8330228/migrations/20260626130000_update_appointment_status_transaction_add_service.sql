-- Migration: Add service_id override to update_appointment_status_transaction RPC
-- Date: 2026-06-26
-- Extends the ACID transaction to support inline service modification during approval.
