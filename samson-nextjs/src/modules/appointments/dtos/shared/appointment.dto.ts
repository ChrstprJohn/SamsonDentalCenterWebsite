...
const appointmentDbSchema = z.object({
  ...
  proposed_time_preference: z.enum(['MORNING', 'AFTERNOON']).nullable().optional(),
...
export const appointmentDtoSchema = appointmentDbSchema.transform((data) => ({
  ...
  timePreference: data.time_preference || null,
  proposedTimePreference: data.proposed_time_preference || null,
