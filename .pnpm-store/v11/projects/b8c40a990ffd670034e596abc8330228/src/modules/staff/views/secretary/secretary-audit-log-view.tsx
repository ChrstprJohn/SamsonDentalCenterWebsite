...
import { useSecretaryAuditLog } from '@/modules/staff/hooks/secretary/use-secretary-audit-log';
import { Input } from '@/components/ui/input';
import { Select } from '@/components/ui/select';

export function SecretaryAuditLogView() {
  const { searchTerm, setSearchTerm, actionFilter, setActionFilter, filteredAudits } = useSecretaryAuditLog();
