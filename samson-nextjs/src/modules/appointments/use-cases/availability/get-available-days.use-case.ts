import { GetAvailableDaysDto, GetAvailableDaysResponseDto, AppointmentResponseDto, GetAvailableTimeSlotsResponseDto, WorkingScheduleMonthItem, AvailabilityMapDto } from '../../dtos/exports';
