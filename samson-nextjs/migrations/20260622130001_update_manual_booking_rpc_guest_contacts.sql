-- Migration: Update create_manual_booking RPC to use guest_contacts
-- Date: 2026-06-22
-- Replaces: appointment_inquiries insert in guest mode → guest_contacts insert
...
BEGIN
    ...
    -- 2. If guest mode (no patient account), snapshot contact details in guest_contacts
