-- Migration: Restore channel-aware status change outbox trigger
-- Date: 2026-08-05
--
-- 20260728003000 made this trigger emit only the configured confirmation_channel,
-- but 20260804210000 / 20260804220000 recreated the function and dropped the v_channel
-- gating, so CANCEL_BOOKING_SMS / RESCHEDULE_BOOKING_SMS entered the delivery log
-- even for EMAIL-only appointments. This recreates the function with gating restored.
