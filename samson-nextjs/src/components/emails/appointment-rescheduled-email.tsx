...
export const AppointmentRescheduledEmail = ({
  ...
  const hasOldDetails = !!(oldDoctorName || oldServiceName || oldDateStr || oldTimeRangeStr);
    ...
    <Html lang="en">
      ...
      <Body style={{ backgroundColor: '#ffffff', fontFamily, margin: '0', padding: '0' }}>
        <Container className="eml-body" style={{ maxWidth: '720px', margin: '0 auto', padding: '36px 36px 44px' }}>
          ...
          {/* Previously scheduled details card */}
          {hasOldDetails && (
            <Section style={{ margin: '0 0 20px', paddingLeft: 0 }}>
              <div style={cardStyle}>
                <Text style={{ ...pStyle, margin: '0 0 8px', fontWeight: 700, color: '#64748b' }}>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 14, fontFamily }}>
                  <tbody>
                    {oldDateStr && (
                      <tr>
                        <td style={{ ...labelCellStyle, width: 120, color: '#64748b', padding: '4px 12px 4px 0' }}>Date:</td>
                        <td style={{ ...valueCellStyle, color: '#64748b', textDecoration: 'line-through', padding: '4px 0' }}>{oldDateStr}</td>
                      </tr>
                    )}
                    {oldTimeRangeStr && (
                      <tr>
                        <td style={{ ...labelCellStyle, width: 120, color: '#64748b', padding: '4px 12px 4px 0' }}>Time:</td>
                        <td style={{ ...valueCellStyle, color: '#64748b', textDecoration: 'line-through', padding: '4px 0' }}>{oldTimeRangeStr}</td>
                      </tr>
                    )}
                    {oldServiceName && (
                      <tr>
                        <td style={{ ...labelCellStyle, width: 120, color: '#64748b', padding: '4px 12px 4px 0' }}>Service:</td>
                        <td style={{ ...valueCellStyle, color: '#64748b', textDecoration: 'line-through', padding: '4px 0' }}>{oldServiceName}</td>
                      </tr>
                    )}
                    {oldDoctorName && (
                      <tr>
                        <td style={{ ...labelCellStyle, width: 120, color: '#64748b', padding: '4px 12px 4px 0' }}>Doctor:</td>
                        <td style={{ ...valueCellStyle, color: '#64748b', textDecoration: 'line-through', padding: '4px 0' }}>{oldDoctorName}</td>
                      </tr>
                    )}
                  </tbody>
                </table>
          ...
          <Section style={{ margin: '0 0 20px', paddingLeft: 0 }}>
            <Text style={{ ...pStyle, margin: '0 0 8px', fontWeight: 700 }}>Your new appointment details:</Text>
            <div style={cardStyle}>
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 14, fontFamily }}>
                <tbody>
                  <tr>
