...
export const clinicConfigAppSchema = z.object({
  ...
  websiteLogoUrl: z.string().url("Website logo must be a valid URL").nullable(),
  websiteLogoDarkUrl: z.string().url("Website dark logo must be a valid URL").nullable(),
  emailLogoUrl: z.string().url("Email logo must be a valid URL").nullable(),
  emailLogoDarkUrl: z.string().url("Email dark logo must be a valid URL").nullable(),
...
export const clinicConfigDbSchema = z.object({
  ...
  website_logo_url: z.string().url("Website logo must be a valid URL").nullable().optional(),
  website_logo_dark_url: z.string().url("Website dark logo must be a valid URL").nullable().optional(),
  email_logo_url: z.string().url("Email logo must be a valid URL").nullable().optional(),
  email_logo_dark_url: z.string().url("Email dark logo must be a valid URL").nullable().optional(),
  address: z.string().min(1, "Address is required"),
...
export const clinicConfigResponseSchema = clinicConfigDbSchema.transform((record) => ({
  ...
  websiteLogoUrl: record.website_logo_url ?? null,
  websiteLogoDarkUrl: record.website_logo_dark_url ?? null,
  emailLogoUrl: record.email_logo_url ?? null,
  emailLogoDarkUrl: record.email_logo_dark_url ?? null,
