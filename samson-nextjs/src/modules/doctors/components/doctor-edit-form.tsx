      ...
      {doctor && (
        <div className="flex items-center gap-2 py-1">
          <input
            ...
            id="isActive"
            {...register('isActive')}
            className="w-3.5 h-3.5 rounded border-slate-200 dark:border-white/10 text-blue-500 focus:ring-blue-500"
          />
          <label htmlFor="isActive" className="text-xs font-semibold text-text-secondary">
