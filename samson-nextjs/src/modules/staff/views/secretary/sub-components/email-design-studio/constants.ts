...
export const DEFAULT_COPY: Record<EmailDesignId, DraftCopy> = {
  ...
  'staff-reply': {
    ...
    preheader: 'Our clinic team has shared an update regarding your appointment.',
    headerLabel: 'Clinic Message',
    headline: 'A Message from Our Clinic Team',
    intro: 'A member of our clinic staff has sent an update regarding your appointment. We are standing by to help.',
    ctaLabel: '',
    primaryInstruction: '',
    secondaryInstruction: '',
    footerText: 'Samson Dental Center • Caring for Your Smile',
