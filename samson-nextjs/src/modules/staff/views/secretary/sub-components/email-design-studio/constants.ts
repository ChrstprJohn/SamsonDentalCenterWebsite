...
export const DEFAULT_COPY: Record<EmailDesignId, DraftCopy> = {
  ...
  'no-show': {
    ...
    preheader: 'No worries — life happens. Tell us what happened, and rebook whenever you are ready.',
    headerLabel: 'Missed Appointment',
    headline: 'You Missed Your Appointment',
    intro: "You missed your appointment at Samson Dental Center. No worries — life happens. Review your visit details below, and rebook whenever you're ready.",
